...
bamPEFragmentSize --maxFragmentLength 5000 -p 24 -b $(ls -1 *_1.bam | xargs) -o ../figures/bam_fragments_sizes_1.png
bamPEFragmentSize --maxFragmentLength 5000 -p 24 -b $(ls -1 *_2.bam | xargs) -o ../figures/bam_fragments_sizes_2.png
...
bamPEFragmentSize --maxFragmentLength 5000 -p 24 -b $(ls -1 filtered/*_1.bam | xargs) -o ../figures/bam_filtered_fragments_sizes_1.png
bamPEFragmentSize --maxFragmentLength 5000 -p 24 -b $(ls -1 filtered/*_2.bam | xargs) -o ../figures/bam_filtered_fragments_sizes_2.png
